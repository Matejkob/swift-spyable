...
final class UT_TypeSyntaxSanitizer: XCTestCase {
  ...
  func testSanitizeDictionaryTypes() {
    ...
    XCTAssertEqual(
      TypeSyntaxSanitizer.sanitize(TypeSyntax(stringIntDictType)), "DictionaryStringInt")
    ...
    XCTAssertEqual(
      TypeSyntaxSanitizer.sanitize(TypeSyntax(intStringDictType)), "DictionaryIntString")
  }
  ...
  func testSanitizeNestedDictionaryTypes() {
    ...
    XCTAssertEqual(
      TypeSyntaxSanitizer.sanitize(TypeSyntax(nestedDictType)),
      "DictionaryStringDictionaryStringInt")
  }
  ...
  func testSanitizeDoubleOptionalTypes() {
    ...
    XCTAssertEqual(
      TypeSyntaxSanitizer.sanitize(TypeSyntax(doubleOptionalType)), "OptionalOptionalString")
  }
  ...
  func testSanitizeOptionalCollectionTypes() {
    ...
    XCTAssertEqual(
      TypeSyntaxSanitizer.sanitize(TypeSyntax(optionalArrayType)), "OptionalArrayString")
    ...
    XCTAssertEqual(
      TypeSyntaxSanitizer.sanitize(TypeSyntax(arrayOptionalType)), "ArrayStringOptional")
  }
  ...
  func testSanitizeMemberTypes() {
    ...
    XCTAssertEqual(
      TypeSyntaxSanitizer.sanitize(TypeSyntax(nestedMemberType)), "FoundationDataIndex")
  }
